...
#define CPU_OP_READ_BIT_CONST_B_DECL(op) cpu_op_read_bit_const_b_##op
#define CPU_OP_READ_BIT_CONST_B(op) \
   static inline void CPU_OP_READ_BIT_CONST_B_DECL(op) (void) \
   { \
      L rd.l = cpu_op_readpc(); \
